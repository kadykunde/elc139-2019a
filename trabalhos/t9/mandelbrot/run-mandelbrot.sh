#!/bin/bash
#SBATCH -J mandelbrot_cuda           # job name
#SBATCH -o mandelbrot_cuda.out     # output file name (%j expands to jobID), this file captures standered output from the shell
#SBATCH -e mandelbrot_cuda.err     # error file name (%j expands to jobID), this file captures errors generated from the program
...
# execute any program
make -f Makefile
srun ./mandelbrot_cuda < mandelbrot.in
